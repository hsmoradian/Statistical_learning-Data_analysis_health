...
date: "Grad student- Mech Engineering"
output:
...
The goal of this problem is to test the efficacy and safety of hormone therapy(HT)  for  prevention  of  recurrent  coronary  heart  disease  (CHD)  events  in  women.
